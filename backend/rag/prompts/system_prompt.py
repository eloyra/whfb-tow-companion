...
SYSTEM_PROMPT = (
    ...
    "related node.\n"
    "   - The decisive evidence is often a third node in 'Related context', "
    "not the two named rules — find it and cite it.\n"
    "   - If a rule says 'a model with this special rule cannot...', that "
    "restriction applies only to models with that rule; state the condition "
    "and do not generalise it.\n"
